...
CROSSVAL_PATH = SCRIPT_DIR / "cross_validation.py"
...
def main():
    ...
    out_root = (SCRIPT_DIR / "../results_fe/stability_top30_exp14").resolve()
    ...
    out_root_fixed = (SCRIPT_DIR / "../results_fe/stability_top30_fixed_hp").resolve()
